  ...
  return {
    storageItem: function (item) {
      ...
      if (localStorage.getItem("items") === null) {
        // Set item to an empty arry
        items = [];
        // Push new item
        items.push(item);
        // Set items as a string
...
const App = (function (ItemCtrl, StorageCtrl, UICtrl) {
  ...
  const deleteItemSubmit = function (e) {
    ...
    StorageCtrl.deleteItemsFromLS(currentItem.id);
  ...
  const clearAllItemsClick = function () {
    // Delete items from data strucre
